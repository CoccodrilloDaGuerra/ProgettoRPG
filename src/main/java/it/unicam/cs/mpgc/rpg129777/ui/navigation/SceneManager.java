package it.unicam.cs.mpgc.rpg129777.ui.navigation;
...
public class SceneManager {
    ...
    private static  final String  STYLESHEET_PAHT= "/it/unicam/cs/mpgc/rpg129777/ui/css/style.css";
    ...
    public static void switchTo(String viewName){
        try {
            String path= "/it/unicam/cs/mpgc/rpg129777/ui/views/" + viewName + ".fxml";
